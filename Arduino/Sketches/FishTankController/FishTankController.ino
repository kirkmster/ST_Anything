...
#define PIN_SWITCH_3              D8  //SmartThings Capability "Switch"
//#define PIN_CONTACT_1             D4  //SmartThings Capabilty "Contact Sensor"
...
#define PIN_BUTTON_2              D7  //SmartThings Capabilty Button / Holdable Button (Normally Open!)
...
#define PIN_TEMPERATURE_1         D1  //SmartThings Capabilty "Temperature Measurement" (Dallas Semiconductor DS18B20)
...
IPAddress hubIp(192, 168, 1, 34);    // smartthings/hubitat hub ip //  <---You must edit this line!
...
//  static st::IS_Button              sensor4(F("button1"), PIN_BUTTON_1, 1000, LOW, true, 500);
  ...
  static st::S_TimedRelay           sensor8(F("relaySwitch1"), PIN_TIMEDRELAY_1, LOW, true, 30000, 0, 1);
